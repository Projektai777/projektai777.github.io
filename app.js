...
const STR = {
  lt: {
    ...
    privacy: '🔒 Jokių asmens duomenų — nereikia nei vardo, nei el. pašto.',
    ...
    startSteps: [
      ...
      ['✅', 'Atsiskaitote', '30 % avansas pasirašius, 70 % — pridavus darbus. Jokių prenumeratų.'],
    ],
    ...
    ownerPrivacy: '🔒 Jokių asmens duomenų — nereikia nei vardo, nei el. pašto, todėl nelieka GDPR rūpesčių.',
    ...
    faq: [
      ...
      ['Kiek tai kainuoja?',
        '<strong>1000 € vienkartinis mokestis</strong> už visą sukurtą produktą — <strong>jokių mėnesinių ar metinių mokesčių</strong>. Įskaičiuoti <strong>pirmi metai nemokamo palaikymo</strong> (klaidų taisymas, smulkūs pakeitimai); vėlesni pakeitimai — už iš anksto sutartą fiksuotą kainą. Rimtos agentūros panašų individualų sprendimą paprastai įkainoja <strong>3 000–8 000 €</strong>, dažnai dar su mėnesiniu mokesčiu — tad 1000 € vienkartinė kaina yra itin palanki.'],
      ...
      ['Ar tai saugu? Kaip su privatumu ir sukčiavimu?',
        '<strong>Privatumas:</strong> nerenkame jokių asmens duomenų — klientui nereikia nei vardo, nei el. pašto, nei registracijos, todėl nelieka ir GDPR (Bendrasis duomenų apsaugos reglamentas) rūpesčių dėl klientų sąrašų. <strong>Sukčiavimas:</strong> tikroje (paleistoje) kortelėje antspaudų skaičius ir slaptasis raktas saugomi <strong>mūsų saugiame serveryje</strong>, o <strong>ne kliento telefone</strong> — tad net technologijas išmanantis klientas, bandydamas redaguoti savo telefoną, nieko nelaimi: tikrasis skaičius atkuriamas iš serverio. Antspaudą galima pridėti tik nuskaičius darbuotojo QR kodą, kurį <strong>sugeneruoja serveris</strong> ir kuris keičiasi kas 30 sekundžių; serveris jį patikrina ir leidžia <strong>tik vieną antspaudą vienai kortelei per dieną</strong> (ir vieną prizą per dieną). <strong>Darbuotojų kontrolė:</strong> darbuotojo kodo puslapis apsaugotas slaptažodžiu ir gali būti <strong>susietas su Jūsų įstaigos vieta</strong> — jei kas nors bandytų jį atidaryti ne vietoje (pvz. namie), serveris kodo tiesiog neišduoda, tad parsineštas slaptažodis tampa bevertis; pamestą ar svetimą įrenginį galima akimirksniu užblokuoti. Savininko apžvalgoje matote <strong>anoniminius dienos antspaudų skaičius</strong> — be jokių asmens duomenų. Specialios dovanos (pvz. gimtadienio) atiduodamos tik darbuotojui patikrinus asmens dokumentą ir tik kartą per metus. <strong>Saugiausias prizo tipas — nuolaida</strong> (pvz. −20 % sąskaitai): net jei kas bandytų apgauti, vis tiek turi išleisti pinigų, nes nuolaida taikoma tik apmokamam pirkiniui — skirtingai nei visiškai nemokamas prizas.'],
  ...
  en: {
    ...
    privacy: '🔒 No personal data — no name, no email, no sign-up.',
    ...
    startSteps: [
      ...
      ['✅', 'You pay', '30% deposit on signing, 70% on delivery. No subscriptions.'],
    ],
    ctaLead: 'A one-time investment that works every day — no monthly fees.',
    ownerContact: 'Ready to start?',
    ownerContactSub: 'Let’s talk →',
    ownerPrivacy: '🔒 No personal data — no name, no email, so no GDPR headaches.',
    ...
    faq: [
      ...
      ['How much does it cost?',
        'A <strong>one-time fee of €1000</strong> for the finished product — <strong>no monthly or yearly fees</strong>. The <strong>first year of support</strong> (bug fixes, small changes) is included; later changes are at a fixed price agreed in advance. A serious agency typically prices a comparable custom build at <strong>€3,000–8,000</strong>, often plus a monthly maintenance fee — which makes the one-time €1000 exceptional value.'],
      ...
      ['Is it safe? What about privacy and cheating?',
        '<strong>Privacy:</strong> we collect no personal data — customers need no name, email or sign-up, so there are no GDPR (General Data Protection Regulation) headaches over customer lists. <strong>Cheating:</strong> on your live card the stamp count and the secret key are held on <strong>our secure server</strong>, <strong>not on the customer’s phone</strong> — so even a tech-savvy customer editing their phone gains nothing: the real count is restored from the server. A stamp can only be added by scanning the staff QR, which is <strong>generated by the server</strong> and rotates every 30 seconds; the server validates it and allows <strong>only one stamp per card per day</strong> (and one reward per day). <strong>Staff oversight:</strong> the staff code page is password-protected and can be <strong>tied to your venue’s location</strong> — if someone tries to open it off-site (e.g. at home), the server simply refuses to issue a code, so a password taken home is useless; a lost or unknown device can be revoked instantly. The owner overview shows <strong>anonymous daily stamp totals</strong> — with no personal data. Special gifts (e.g. birthday) are released only after staff check an ID, and only once per year. <strong>The safest type of reward is a discount</strong> (e.g. −20% off the bill): even if someone tried to cheat, they still have to spend money, because the discount applies only to a paid purchase — unlike an entirely free reward.'],
