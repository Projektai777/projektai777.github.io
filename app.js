  ...
  en: {
    ...
    faq: [
      ...
      ['How much does it cost?',
        'A <strong>one-time fee of €1000</strong> for the finished product — <strong>no monthly or yearly fees</strong>. The <strong>first year of support</strong> (bug fixes, small changes) is included. For comparison: most similar tools are subscriptions of ~€25–80/month (~€300–960/year, every year), and versions with your own brand and domain are the priciest tier. Here you pay once and use the product indefinitely — no subscriptions. Compared with a ~€30/month subscription, it pays for itself in about 2–3 years and then runs for free. A serious agency typically prices a comparable custom build at <strong>€3,000–8,000</strong> (a full native iOS/Android app with integrations runs €15,000+), usually plus a monthly maintenance fee — which makes the one-time €1000 exceptional value.'],
