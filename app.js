...
const STR = {
  lt: {
    ...
    faq: [
      ...
      ['Kiek tai kainuoja?',
        '<strong>1000 € vienkartinis mokestis</strong> už visą sukurtą produktą — <strong>jokių mėnesinių ar metinių mokesčių</strong>. Įskaičiuoti <strong>pirmi metai nemokamo palaikymo</strong> (klaidų taisymas, smulkūs pakeitimai). Palyginkite: dauguma panašių sprendimų yra prenumeratos po ~25–80 €/mėn. (~300–960 €/metus, ir taip kasmet), o versijos su Jūsų prekės ženklu ir domenu — pačios brangiausios. Čia sumokate vieną kartą ir produktas lieka Jūsų.'],
      ...
      ['Kaip vyksta sutartis ir atsiskaitymas?',
        'Dirbu legaliai pagal individualios veiklos pažymą, todėl Jums viskas paprasta: gaunate <strong>vieną sąskaitą faktūrą</strong> (be PVM — kol neviršijama 45 000 €/metus riba), apmokate banko pavedimu ir apskaitote kaip įprastą paslaugą. <strong>Jokio mokesčių išskaičiavimo, „Sodros" ar darbdavio prievolių</strong> — savo mokesčius (GPM, VSD, PSD) deklaruoju ir sumoku pats. Pasirašome trumpą, aiškią paslaugų sutartį: kas sukuriama, kaina, terminai, 1 metų palaikymas ir kad gatavas produktas tampa Jūsų nuosavybe. Atsiskaitoma dviem dalimis: 30 % avansas pasirašius, 70 % pridavus darbus. Jokios biurokratijos iš Jūsų pusės.<a class="faq-pdf" href="docs/lojalumas-sutartis-sablonas.pdf" target="_blank" rel="noopener">📄 Peržiūrėti sutarties šabloną (PDF)</a>'],
      ['Kas vyksta po pirmų metų?',
        'Pirmi metai palaikymo — nemokami. Vėliau produktas toliau veikia be jokių privalomų mokesčių. Prireikus pakeitimų ar naujų funkcijų, susitarsime dėl fiksuotos kainos už konkretų darbą — jokių prenumeratų.'],
    ],
  ...
  en: {
    ...
    faq: [
      ...
      ['How do the contract and payment work?',
        'I work legally as registered self-employed (Lithuanian “individuali veikla”), so for you it stays simple: you get a <strong>single invoice</strong> (VAT-free, under the €45,000/year threshold), pay by bank transfer, and book it as a normal service. <strong>No tax withholding, no Sodra, no employer obligations</strong> — I declare and pay my own taxes (income, social and health). We sign a short, clear service agreement: what’s built, the price, deadlines, 1 year of support, and that the finished product becomes your property. Payment is in two parts: 30% deposit on signing, 70% on delivery. No bureaucracy on your side.<a class="faq-pdf" href="docs/lojalumas-sutartis-sablonas.pdf" target="_blank" rel="noopener">📄 View the sample contract (PDF, in Lithuanian)</a>'],
