  ...
  lt: {
    ...
    faq: [
      ...
      ['Kaip vyksta sutartis ir atsiskaitymas?',
        'Dirbu legaliai pagal individualios veiklos pažymą, todėl Jums viskas paprasta: gaunate <strong>vieną sąskaitą faktūrą</strong> (be PVM — kol neviršijama 45 000 €/metus riba), apmokate banko pavedimu ir apskaitote kaip įprastą paslaugą. <strong>Jokio mokesčių išskaičiavimo, „Sodros" ar darbdavio prievolių</strong> — savo mokesčius (GPM, VSD, PSD) deklaruoju ir sumoku pats. Pasirašome trumpą, aiškią paslaugų sutartį: kas sukuriama, kaina, terminai, 1 metų palaikymas ir kad gatavas produktas tampa Jūsų nuosavybe. Galima atsiskaityti ir dalimis (avansas + likutis pridavus). Jokios biurokratijos iš Jūsų pusės.<a class="faq-pdf" href="docs/lojalumas-sutartis-sablonas.pdf" target="_blank" rel="noopener">📄 Peržiūrėti sutarties šabloną (PDF)</a>'],
