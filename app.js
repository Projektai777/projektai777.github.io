  ...
  lt: {
    ...
    faq: [
      ...
      ['Kaip vyksta sutartis ir atsiskaitymas?',
        'Dirbu legaliai pagal individualios veiklos pažymą. Pasirašome paslaugų teikimo sutartį, kurioje aiškiai surašoma apimtis, kaina, terminai, palaikymas ir tai, kad gatavas produktas priklauso Jums. Išrašau sąskaitą faktūrą; apmokėjimas — banko pavedimu (galima dalimis: avansas + likutis pridavus). Sąskaita be PVM, o mokesčius už savo veiklą tvarkau pats — Jums jokių papildomų darbdavio prievolių.'],
