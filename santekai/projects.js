...
var PROJECTS = [
  ...
  {
    id: 'katiline-ringaudai',
    title: 'Katilinės įrengimas privačiame name',
    cats: ['sildymas', 'butai'],
    object: 'Privatus namas, 180 m²',
    place: 'Kauno r., Ringaudai',
    year: 2026,
    duration: '8 darbo dienos',
    photo: './img/svok.webp',
    summary: 'Pilna katilinė nuo nulio: dujinis katilas, akumuliacinė talpa, kolektoriai ir grindinis šildymas.',
    works: [
      'Sumontuotas kondensacinis dujinis katilas',
      'Įrengta akumuliacinė talpa ir karšto vandens boileris',
      'Surinkti kolektoriai atskiroms šildymo grupėms',
      'Paklotas grindinis šildymas pirmame aukšte',
      'Sistema subalansuota ir suderinta',
    ],
    result: 'Namas šildomas viena sistema, kiekvienas aukštas reguliuojamas atskirai.',
    tags: ['Dujinis katilas', 'Grindinis šildymas', 'Kolektoriai'],
  },
  {
  ...
  {
    id: 'magistrale-eiguliai',
    title: 'Magistralinių vamzdynų keitimas rūsyje',
    cats: ['daugiabuciai'],
    object: 'Daugiabutis, 2 sekcijos',
    place: 'Kaunas, Eiguliai',
    year: 2025,
    duration: '12 darbo dienų',
    cover: 'magistrale',
    summary: 'Pakeistos vandentiekio ir šildymo magistralės rūsyje, prijungta prie miesto tinklų.',
    works: [
      'Pakeista vandentiekio magistralė visame rūsyje',
      'Pakeistos šildymo sistemos magistralės',
      'Pakeisti nuotekų ir lietaus vamzdžiai',
      'Prijungimas prie miesto tinklų suderintas su tiekėju',
      'Vamzdynai izoliuoti, paženklinta srauto kryptis',
    ],
    result: 'Rūsyje nebeliko avarinių vietų, šilumos nuostoliai magistralėse sumažėjo.',
    tags: ['Miesto tinklai', 'Izoliacija'],
  },
  {
    id: 'cipp-vilijampole',
